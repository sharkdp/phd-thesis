...
we will briefly introduce three kinds of physical systems which can be used to realize dipolar spin
models: dipolar atoms, polar molecules and Rydberg atoms.

The next step is to understand the structure of the dipole-dipole interaction. While static
dipolar interactions in ultracold systems are of interest and importance on their own
\cite{Goral1999,Santos2000a,Santos2003a,Griesmaier2005a,Stuhler2005,Ronen2007a,Koch2008a,Lahaye2008a,Lahaye2009},
we are mostly going to focus on dipolar exchange interactions
where the internal state of the dipolar particles can change
\cite{Huber2011,Yan2013,DePaz2013,Hazzard2014,Barredo2014,Syzranov2014}.
While static dipolar interactions may be used to simulate Ising-type spin
interactions, exchange terms can be used to engineer $XY$ type spin interactions
\cite{Micheli2006,Hauke2010,Gorshkov2011,Gorshkov2011b,Peter2012b,Syzranov2014,Peter2014}.
...
\refcite{Lahaye2009}. Other systems which can be used to simulate spin models include trapped ions
setups~\cite{Britton2012,Kim2010}, NV centers in diamond~\cite{Cai2012} or optical lattice clocks
\cite{Martin2013}.
...
to cool and manipulate as well as the absence of chemical reactions present in polar molecules
...
realization of spin systems~\cite{Weber2015}.
