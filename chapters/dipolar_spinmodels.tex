...
setups~\cite{Britton2012,Kim2010}, nuclear spins in diamond~\cite{Cai2012} or optical lattice
...
\end{align}
Then, including the terms that do not conserve the energy, proportional to $\sminus_i\sminus_j$, the Hamiltonian reduces to
