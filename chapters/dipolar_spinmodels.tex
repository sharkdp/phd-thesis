...
given by $H_\text{rot}=B J^2 - \vecd \vecE$, where $B$ is the rotational
constant $\vecd$ is the dipole moment which couples to an external
electric field $\vecE$. In the absence of any external fields, the
...
\begin{align}
    d_0 &= \smallbraketop{0}{d^0}{0} = -\muBg/2, \vphantom{\sqrt{2}} \\
    d_+ &= \smallbraketop{+}{d^0}{+} = +\muBg/2, \vphantom{\sqrt{2}} \\
    q_+ &= |\smallbraketop{+}{d^+}{0}| = \smallbraketop{+}{\sqrt{2} \sigma^+}{0} = +\muBg/\sqrt{2}.
\end{align}
