...
% TODO proposals:
% polar molecules
% Micheli2006,Hauke2010,Gorshkov2011,Gorshkov2011b,Peter2012b,Syzranov2014,Peter2014
...
differences. A detailed review on dipolar systems can be found in \refcite{Lahaye2009}.

% TODO mention NV centers
...
particular electronic structure. In the meantime, a large number of different dipolar atoms
...
dipole moment. Both bosonic \cite{Lu2011} and fermionic quantum degenerate gases \cite{Lu2012}
have been demonstrated. The same is true for Erbium with a magnetic moment of $7\muB$, where also
both bosonic \cite{Aikawa2012} and fermionic isotopes \cite{Aikawa2014} can be cooled to quantum
degeneracy.

In their electronic ground state, these atoms typically posses a large amount of internal hyperfine
states which contribute to a rich internal structure that can be controlled via Zeeman shifts and
optical pumping techniques.

Compared to polar molecules, magnetic atoms have a permanent dipole moment, even at zero field.
This is useful for certain applications which involve dipolar relaxation such as demagnetization
cooling \cite{}. Other advantages compared to polar molecules are the generally easier structure
which makes them easier to cool and manipulate as well as the absence of chemical reactions
\cite{}.
...
\cite{}. Different species of polar molecules have been successfully cooled, among them KRb
\cite{Ni2008b,Ospelkaus2010}, NaK \cite{Wu2012a} and NaLi \cite{Heo2012}.
...
field induces static dipole moments which can are constrained by the permanent electric dipole
moment $d$ of the molecules. Another important difference compared to magnetic atoms is the
rotational splitting $B$ which is typically much larger than the dipolar interaction strength
$\kappa d^2/a^3$ between two molecules at realistic inter-molecule separations $a$.

Polar molecules can be trapped in optical lattices \cite{Chotia2012}. The experimentally achievable
...
excited Rydberg atoms can be very similar to polar molecules. Dipolar effects have been observed
in Rydberg atoms \cite{Westermann2006,Nipper2012b} and the achievable dipole moments can be even
larger than for polar molecules \cite{}.
