...
\todo{permament dipole moment, hyperfine ground state, lande factor}
...
\subsection{Two internal levels with $\Delta m = 0$ (Anomalous behavior)}

Call the states $\ketup$ and $\ketdn$. We only consider the energy-conserving terms because $\Vdd \ll B$. The only relevant terms in the interaction is $d^0d^0$ which generates both an $\sz \sz$ term and the tunneling term $\splus\sminus$.

\subsection{Two internal levels with $\Delta m = 1$ (dipolar fermions and 1,+ model?)}
now $d^0d^0$ only generates an interaction term $\sz \sz$. the term $d^+d^-$ provides an energy conserving tunneling term $\splus\sminus$.

For DF we are also interested in the energy non-conserving term $d^+d^+$ which leads to the $\splus\splus$ contribution.

\subsection{Three internal levels with $\Delta m_{1,2} = \pm 1$ (FE and PM)}
...
\subsection{Three internal levels with $\Delta m_1 = 1, \Delta_m2 = 0$ (+, 1 model)}
