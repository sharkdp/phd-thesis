...
In consequence, the coupling between the two edge states is proportional to $1/L^3$ (see \tref{scaling}).
Conversely, the edge state decays exponentially into the bulk if the dipolar interaction is artificially cut off at a finite distance $R_c < L$.
