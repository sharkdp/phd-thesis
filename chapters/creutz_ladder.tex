...
\end{align}
This two-by-two sector of the full Hamiltonian is identical to a cross-linked ladder model in a magnetic field which has been introduced by Creutz in \refcite{Creutz1999} (see also~\cite{Tovmasyan2013a}).
