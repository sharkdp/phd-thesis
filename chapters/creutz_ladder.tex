\chapter[Realizing the Creutz ladder model with dipolar interactions]{Realizing the Creutz ladder model\texorpdfstring{\\}{ }with dipolar interactions}
\label{creutz_ladder}
...
\begin{align}
    \ep_k &= 2 w_h \cos(ka), \\
    \eta_k^m &= -w_v + 2 w_d \cos(ka + m\delta), \qquad m = \pm 2.
\end{align}
...
\begin{align}
    \et^s_k = \frac{1}{2} \bb{ \et^2_k + \et^{-2}_{k} }, \qquad
    \et^a_k = \frac{1}{2} \bb{ \et^2_k - \et^{-2}_{k} }.
\end{align}
