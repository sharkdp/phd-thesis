...
To derive the parameters of the hopping Hamiltonian in \tref{hrealspace}, we introduce the vacuum state $\ket{\text{vac}}=\prod_k \ketz_k$ and the single particle states $\ket{\Psi_{i,\pm}}=\bopd_{i,\pm} \ket{\text{vac}}$.
...
The energy scale of the hopping rates $t^+$, $t^-$, and $w$ is given by $V$. The precise form depends on the microscopic parameters and is detailed in the \tref{microscopic}.
...
\section{Dispersion relation and Chern number}
\tlabel{chernnumber}
