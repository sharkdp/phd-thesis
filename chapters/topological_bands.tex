...
It is possible to visualize a mapping $T^2 \to S^2$ (see \tref{chern2/wrapping} for an example), but it is easier to continue this discussion with a conceptually easier mapping $S^2 \to S^2$ from a sphere to itself.
...
Functions $f\colon S^1 \to S^1$ from the unit-circle to itself, for example, are classified by the first homotopy group (called the fundamental group).
...
Another way to look at the topological properties of the band structure and the meaning of the Chern number is through the theory of Berry phases.
...
\begin{align}
    \gamma(\mathcal{S}) \equiv \int_{\partial\mathcal{S}} \mathrm{d}\veck \cdot \vec{A}(\veck) = \int_\mathcal{S} \mathrm{d}^2 \veck \, B(\veck)
\end{align}
...
Now let $\mathcal{S}$ be a region $\mathcal{S} \subset T^2$ and $\overline{\mathcal{S}} = T^2 \setminus \mathcal{S}$ be its complement.
Then, the sum of the Berry phases $\gamma(\mathcal{S})$ along $\partial \mathcal{S}$ and $\gamma(\overline{\mathcal{S}})$ along the reversed path $\partial \overline{\mathcal{S}}$ has to be an integer multiple of $2\pi$.
On the other hand, $\gamma(\mathcal{S}) + \gamma(\overline{\mathcal{S}}) = \gamma(T^2) = 2\pi C$, so the Chern number is an integer.
