...
We have introduced the dipolar dispersion relation~\cite{Peter2012b,Syzranov2014}
\begin{align}
...
\doublefig{.42}{fig2/fig2a}{}{.42}{fig2/fig2b}{}{dispersionSquare}{
...
At the $\mathcal{T}$-invariant point, i.e. $t=\mu=0$, the two energy bands of the system exhibit a band touching at the high-symmetry points $\Gamma=(0,0)$ and $\text{M}=(\pi/a, \pi/a)$ where $\epsilon^2_\veck$ vanishes, see \tref{dispersionSquare}a.
%take the from
%\begin{align}
...
\end{align}
and shown in \tref{dispersionSquare}a.
...
\begin{align}
    C &= \frac{1}{4\pi}\int_{\text{BZ}}\!\mathrm{d}{^2\veck}\, ( \partial_{k_x} \hat{\vec{n}}_{\veck} \times \partial_{k_y} \hat{\vec{n}}_{\veck} ) \cdot \hat{\vec{n}}_{\veck} \, . \tlabel{chern}
\end{align}
...
The dispersion relation for $\Theta=0$ and $\pi/4$ is shown in~\tref{dispersionSquare}b.
