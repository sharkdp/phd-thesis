...
and has been identified as the driving mechanism for the Einstein-de Haas effect in Bose-Einstein condensates~\cite{Kawaguchi2006,Peter2013} and the pattern formation in spinor condensates~\cite{Santos2006,Vengalattore2008,Kurn2013}.
...
These ideas are motivated by the experimental success in cooling and trapping polar molecules in optical lattices~\cite{Lahaye2009,Ni2008b,Ospelkaus2010,Wu2012a,Heo2012,Chotia2012}.
...
An important aspect for topological phases is the role of symmetries~\cite{Schnyder2008,Kitaev2009,Ryu2010}. For the purposes of this chapter, we are mainly interested in time-reversal symmetry.
...
In the presence of time-reversal symmetry, represented by $\mathcal{T}=\sigma_x \mathcal{K}$ with $\mathcal{K}$ being complex conjugation, the system reduces to the one discussed by Syzranov~\etal~\cite{Syzranov2014}.
...
\Cref{tb:edge/edge-square,tb:edge/edge-honeycomb} depict the two-dimensional structure of the edge-states in a small finite system for the square and honeycomb lattices. \Cref{tb:edge/edge-square-disordered,tb:edge/edge-honeycomb-disordered} show the same system with a fraction of $\rho=0.2$ of the lattice sites removed, demonstrating the robustness of the edge states against missing molecules.
For more details on the edge states in our system, we refer to follow-up work by Weber~\cite{Weber2015}.
