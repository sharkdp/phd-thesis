...
\doublefig{.465}{fqhe-comparison}{ }{.436}{lll-excitations}{ }{\sfA~Density distributions for interacting ground states of $N=6$ particles at total angular momentum $L=\liqhe, 2\liqhe$ and $3\liqhe$. The Laughlin wave function at $m=3$ ($\nu=1/3$) is shown for comparison. \sfB~Ground state energy and excitation spectrum of $N=5$ particles for increasing angular momentum. The inset shows the opening gap at $L=3\liqhe$, corresponding to a filling of $\nu = 1/3$.}
