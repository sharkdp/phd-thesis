...
\doublefig{.49}{fqhe-comparison}{\tlabel{fqhe-comparison}}{.46}{lll-excitations}{\tlabel{lll-excitations}}{fqhe}{(a) Density distributions for interacting ground states of $N=6$ particles at total angular momentum $L=\liqhe, 2\liqhe$ and $3\liqhe$. The Laughlin wave function at $m=3$ ($\nu=1/3$) is shown for comparison. (b) Ground state energy and excitation spectrum of $N=5$ particles for increasing angular momentum. The inset shows the opening gap at $L=3\liqhe$, corresponding to a filling of $\nu = 1/3$.}
