...
In this regime, highly correlated ground states appear that are closely connected to fractional quantum Hall effect (FQHE) states. For a discussion in the context of rotating systems, see~\cite{Osterloh2007}.
...
Each term in such an integer partition is related to the angular momentum offset of one particle from its initial position at $\Delta L = 0$.
