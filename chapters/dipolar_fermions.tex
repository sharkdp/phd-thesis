...
\right],
\end{align}
which is the expression given in \refandpage{ds:hdd2dmagnetic}. Here, $R$ and $\phi$ are polar coordinates in the $xy$ plane and $\Cdd = \kappa \muB^2 g^2 / 4$ characterizes the strength of the interaction.
...
\doublefig{.454}{fqhe-comparison}{ }{.436}{lll-excitations}{ }{\sfA~Density distributions for interacting ground states of $N=6$ particles at total angular momentum $L=\liqhe, 2\liqhe$ and $3\liqhe$. The Laughlin wave function at $m=3$ ($\nu=1/3$) is shown for comparison. \sfB~Ground state energy and excitation spectrum of $N=5$ particles for increasing angular momentum. The inset shows the opening gap at $L=3\liqhe$, corresponding to a filling of $\nu = 1/3$.}
