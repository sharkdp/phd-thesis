...
For a detailed overview on this topic, see \refscite{Balewski2013,Balewski2014} as well as~\refscite{Karpiuk2014,Gaj2014}.
...
\bigskip
Finally, \tref{losses} shows the quantity $L/\tau^2$ in a comparison between experiment and theory. The agreement is reasonably well if the measured lifetimes are taken into account (see also~\refcite{Karpiuk2014}).
