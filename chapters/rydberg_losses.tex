\chapter{Rydberg electron-induced atom losses}
...
In the experiment, performed by Jonathan Balewski and coworkers, a single atom within a Rubidium condensate is excited to a \mbox{high-$n$} Rydberg state whose extent includes several thousands of ground state atoms.
...
For a detailed overview on this topic, see Balewski~\etal~\cite{Balewski2013,Balewski2014} as well as Karpiuk~\etal and Gaj~\etal~\cite{Karpiuk2014,Gaj2014}.
...
\end{align}
\section{BEC excitations and atom losses}
...
\bigskip
Finally, \tref{losses} shows the quantity $L/\tau^2$ in a comparison between experiment and theory. The agreement is reasonably well if the measured lifetimes are taken into account (see also related work by Karpiuk~\etal~\cite{Karpiuk2014}).

\fig{.7}{losses}{Atom losses divided by the square of the Rydberg lifetime $\tau$. Comparison between experiment~\cite{Balewski2014} and theory. For the solid line, a lifetime of $\tau=10\si{\micro\second}$ is assumed while the crosses take the measured Rydberg lifetime into account.}
