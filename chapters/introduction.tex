...
In much the same way that the number of \qu{handles} of a closed two-dimensional manifold can be calculated by an integration over its curvature, the Chern number can be calculated by integrating the system's Berry curvature over a periodic two-dimensional configuration space.
...
% Nowadays, integer quantum Hall samples are seen as examples of materials called topological insulators.
% They behave similar to ordinary band insulators, but have conducting states at the edge of the material that contribute to the quantized Hall conductance.
