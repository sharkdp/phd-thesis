...
The first two chapters discuss the realization and the properties of dipolar spin systems.
...
We work in a useful picture where excitations in the spin system are being thought of as individual particles.
...
This is in contrast to most condensed matter spin systems where interactions are typically exponentially suppressed at larger distances.
The second chapter addresses the modifications which are to be expected from including the long-range dipolar interactions in two-dimensional spin systems.

The third chapter is concerned with the realization of quantum Hall states in ultracold systems.
It is inspired by the ideas of rapidly rotating atomic gases.
We propose to use the mechanism of dipolar relaxation to induce a rotation in a two-dimensional gas of dipolar fermions.
In contrast to usual stirring-techniques, this allows us to have direct control over the total angular momentum of the system.
