...
Electrically neutral atoms do not couple to the magnetic vector potential in the way that electrons do.
Various solutions to this problem have been proposed and succesfully implemented.
Following an analogy that goes back to Larmor, it is possible to use a rapid rotation of the system to induce an effective magnetic field for the neutral particles.
...
% synthetic magnetic field: ideas, experiments
% fast rotating gases: ideas, experiments
