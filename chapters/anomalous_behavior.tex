\chapter[Anomalous behavior of dipolar spin systems]{Anomalous behavior of\texorpdfstring{\\}{ }dipolar spin systems}
...
Then, as demonstrated in \refandpage{ds:hxxz}, the Hamiltonian reduces to a XXZ model with dipole-dipole interaction between the spins~\cite{Gorshkov2011,Muller2009}:
\begin{align}
...
The dependence of the couplings $J$ and $\theta$ on the microscopic parameters is discussed in detail in \cref{ds:xxz} and \refscite{Muller2010,Gorshkov2011,Gorshkov2011c}.
