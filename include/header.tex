...
% We know that usage of titlesec together with KOMA is not recommended.
...
\titleformat{\chapter}[display]
            {\sffamily\bfseries}
            {\raggedleft\color{chaptergrey}\fontsize{3.5cm}{1em}\selectfont\thechapter}
            {0pt}
            {\leavevmode\\\huge\raggedleft}
