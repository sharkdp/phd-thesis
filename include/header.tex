...
\newtoggle{print}
\settoggle{print}{false} % use this to toggle between the two layouts

\iftoggle{print}{
    % Use a two-sided layout for the print version
    \KOMAoption{twoside=true}
}{
    % Use a centered type area for the PDF version. We use twoside=semi
    % to preserve the page numbers between the print layout and PDF layout.
