...
\sidefig{.5\textwidth}{epsk/epsk}{Plot of the function $\epskm$ on a high-symmetry path in the Brillouin zone of the square lattice. The linear behavior at $\veck=\vecGamma$ is apparent as well as the zeros of $\epsk^2$ at $\veck=\vecGamma, \vecM$.}
